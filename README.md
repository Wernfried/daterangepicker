...
If the `startDate` does not fall into [minDate](minDate) and [maxDate](maxDate) then [startDate](startDate) is shifted and a warning is written to console.
